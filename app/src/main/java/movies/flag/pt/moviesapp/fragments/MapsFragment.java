...
import movies.flag.pt.moviesapp.utils.MapsDataParser;
import movies.flag.pt.moviesapp.utils.MapsDownloadUrl;
...
public class MapsFragment extends BaseFragment implements OnMapReadyCallback,
    ...
    private void findViews() {
        mLoaderView = (ProgressBar) view.findViewById(R.id.maps_fragment_loader);
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        String MovieTheater = "movie_theater";
        String url = getUrl(latitude, longitude, MovieTheater);
    ...
    private class GetNearbyPlacesData extends AsyncTask<Object, String, String> {
        ...
        protected String doInBackground(Object... params) {
            try {
                ...
                url = (String) params[1];
                MapsDownloadUrl downloadUrl = new MapsDownloadUrl();
        ...
        protected void onPostExecute(String result) {
            ...
            nearbyPlacesList = mapsDataParser.parse(result);
        ...
        public void ShowNearbyPlaces(List<HashMap<String, String>> nearbyPlacesList) {
            if (nearbyPlacesList.size() == 0) {
                Toast.makeText(mContext, "There are no open cinemas near you", Toast.LENGTH_LONG);
            } else {
